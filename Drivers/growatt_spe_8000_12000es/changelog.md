# Changelog — growatt_spe_8000_12000es
...
## 1.0.0 — 2026-06-15
- Initial HexaOS Extension package, converted from the legacy single-file driver `uart/modbus_rtu/inverter/growatt_spe_8000_12000es.json`.
